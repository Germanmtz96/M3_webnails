...
const Cloudinary = () => {
    ...
    const preset_name = "cloudinaryreixel";                         //16 Pegamos el "name" rescatado en el punto 24
    const cloud_name = "dp3p9o2mr"                          //16.2 Pegamos el cloud_name rescatado en punto 20
