...
function ImgCard(props) {
  ...
  const handleCerrarModalDeletePublicacion = () => setModalDeletePublicacion(false)
    ...
    return (
      <>
        ...
        >
          ...
          <Modal show={modalDeletePublicacion} onHide={handleCerrarModalDeletePublicacion}>
        <Modal.Header closeButton>
          <Modal.Title>¿Estas seguro de borrar la publicación?</Modal.Title>
        </Modal.Header>
        <Modal.Footer>
          <Button variant="secondary" onClick={handleCerrarModalDeletePublicacion}>No</Button>
          ...
          <Modal.Header>
            ...
            <Modal.Body className="comentarios-container" >
              {comentarioArr.map((eachComentario)=> {
                return (
                   <ComentarioCard key={eachComentario._id} publicacion={publicacion} eachComentario={eachComentario} getComentarios={getComentarios}/>
                )
              })}
            </Modal.Body>
          </Modal.Header>
